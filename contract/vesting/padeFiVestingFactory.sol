...
contract PadeFiVestingFactory {
  ...
  function create_vesting (
    ...
    uint256  ReleaseEveryCycle //release amount on every cycle //enter percentage 
      ...
      require(vestingPeriod>0  ,"enter amount in percentage ");
    ...
    PadeFiVesting newToken = new PadeFiVesting(
      ...
      TransferHelper.safeTransferFrom(token ,msg.sender,address(newToken), totalTokens);
