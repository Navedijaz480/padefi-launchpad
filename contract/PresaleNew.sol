...
contract PresaleNew is ReentrancyGuard {
    ...
    function setOwner(address _newOwner) public onlyOwner {
     ...
     function setrefunf(bool _refund) public onlyOwner {
        presale_info.refund = _refund;
    }
    ...
    function userWithdrawTokens () public nonReentrant {
        require(presale_info.refund==true,"you can only b your token");
    ...
    function remainingBurn() public onlyOwner {
        require(presale_info.refund==false,"you can only refund your token");
        require(presaleStatus() == 2, "Not succeeded"); // Success
